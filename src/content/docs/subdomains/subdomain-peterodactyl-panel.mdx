---
title: Create Subdomain > webui.yourdomain.com
author: Sven Rönnfranz alias Grewo
description: Setup for direktconnection to peterodactyl-panel
---
...
<Tabs>
    <TabItem label="Edit Redirect entry">
        ...
        Destination             -   Peterodactyl-Panel-Alias (IP: 10.2.3.2)<br/>
        Destination port from   -   http (80)<br/>
        Destination port to     -   http (80)<br/>
        Redirect Target IP      -   Peterodactyl-Panel-Alias (IP: 10.2.3.2)<br/>
...
<Tabs>
    <TabItem label="Details-Tab">
        Domain Names            -   webui.yourdomain.com<br/>
        Scheme                  -   http<br/>
        Forward Hostname / IP   -   10.2.3.2<br/>
        Forward port            -   80 (Dockge-Port)<br/>
...
<br/>
If the host you have just created has the `status "Online"`, everything has worked and you can reach your proxy manager at `webui.yourdomain.com`.<br/>
