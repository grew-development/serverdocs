...
We will need to edit the line starting with `net0`: and add all your VLANS as trunks `trunks=202;...`<br/>
...
<Tabs>
    <TabItem label="Edit VLAN">
        Device          -   vlan0.202 ( vlan0.\<VLAN_ID> )<br/>
        Parent          -   vtnet1<br/>
        VLAN tag        -   202<br/>
        VLAN priority   -   Default<br/>
        Description     -   202_dockge ( \<VLAN_ID>_\<NAME_FOR_THE_VLAN> )<br/>
    </TabItem>
</Tabs>
